...
# IoSlides - Diapo de titre

## Avertissement

Cette présentation est un essai du programme __ioslide__

To create an ioslides presentation from R Markdown:

- you specify the ioslides_presentation output format in the front-matter of your document. 
...
Cette diapo sans titre a été crée avec la règle "----"

# exemple de diapo | avec un sous titre

## exemple de diapo | avec un sous titre

On peut utiliser les raccourcis clavier pour modifier l'apparencede la présentation: 
...
Appuyer sur Esc pour quitter tous ces modes. 
...
Cette présentation est basée sur le travail de la FEDORU (GT4 Hôpital en tension)
...
![source: ORUPACA](declaration_tension.png)
